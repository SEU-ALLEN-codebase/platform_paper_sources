...
def get_tree():
    with open(f'{__ASSETS__}/tree_yzx.json','r') as f:
...
def load_level_u32csv():
    level_file = f'{__ASSETS__}/level.csv'
...
def get_u32_u16_id_dict():
    u32_u16_id_dict_file = f'{__ASSETS__}/u32_u16_dict.json'
    u32_u16_id_dict = load_json_key2int(u32_u16_id_dict_file)
    return u32_u16_id_dict

def get_u16_u32_id_dict():
    u16_u32_id_dict_file = f'{__ASSETS__}/u16_u32_dict.json'
...
def get_voxel_center_neighbor_dict(level,uint):
    dict_file = f'{__ASSETS__}/n{level}_u{uint}_voxel_center_neighbor_dict.json'
...
def get_u25voxel_dict_from_nrrd(level,uint,imgfile='',allow0=False):    
    if imgfile=='': 
        imgfile = f'{__ASSETS__}/n{level}_u{uint}.nrrd'
